...
[📂 Game Rules](docs/Game-Rules.html) 
...
🥉 **Bronze League**: [Code Winner](code/1st-version-Bronze.html)

**Silver League**: [Code #183 of a total of 1,119 🥈](code/1st-version-Argent.html)
